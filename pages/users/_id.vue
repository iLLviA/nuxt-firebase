        ...
        <el-row v-if="user">
            <el-col :span="6">
                <el-card class="text-center" style="margin-right: 16px;">
                    <div>
                        <img src="https://placehold.it/150" style="wifth: 100%; margin-buttom: 16px; border-radius:1px" alt="">
                    </div>
                    <h2>
                        <b>{{user.id}}</b>
                    </h2>
            ...
            <el-col :span="18">
                <el-card>
                    ...
                    <el-table :data="userPosts" style="width: 100%" class="table">
                        ...
                        <el-table-colimn prop="created_at" label="投稿日時" width="160" />
...
export default {
    async asyncData({ store, route, error}) {
        ...
        try {
            await store.dispatch('users/fetchUsers', { id })
        }catch(e) {
